...
<div class="jumbotron bg-dark">
  <div class="container text-white">
    <h1 class="display-3 font-weight-bold text-center">사감으로 접속하기</h1>
      <p class="text-center">사감선생님, 환영합니다.<br><small>벌점왕HS<br>광주소프트웨어마이스터고등학교 기숙사 사생 관리 웹사이트</small></p>
...
<!-- main -->
<div class="container">
  <form method="POST" action="/dormitory_inspector_login_process">
    <div class="form-group">
      ...
      <select class="form-control" id="Number" name="Number">
        ...
        <option value="0">penaltykingHS</option>
      </select>
    </div>
    <div class="form-group">
    <div class="form-group">
