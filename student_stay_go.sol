  	...
  	<div id="wrapper">
         ...
         <div class="sidebar-scroll">
           <nav>
             <ul class="nav">
               ...
               <li><a href="/student_stay" class="active"><i class="lnr lnr-enter"></i> <span>잔류</span></a></li>
             </ul>
           </nav>
         </div>
       </div>
       <!-- END LEFT SIDEBAR -->
  		...
  		<div class="main" style="padding-top: 82px;">
  			<!-- MAIN CONTENT -->
          <iframe name="ifr" src="/student_stay_go_i" frameborder="0" height="5000px" width="100%"></iframe>
  			<!-- END MAIN CONTENT -->
  	   </div>
  		<!-- END MAIN -->
