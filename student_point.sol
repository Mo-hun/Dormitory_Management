         ...
         <div class="sidebar-scroll">
           <nav>
             <ul class="nav">
               ...
               <li><a href="/student_point" class="active"><i class="lnr lnr-magic-wand"></i> <span>상*벌점 조회</span></a></li>
            ...
            <?php
             ...
             <div class="row">
               <div class="col">
                 <!-- RECENT PURCHASES -->
                 <?php
                   include_once('./include/student_point.php');
                  ?>
